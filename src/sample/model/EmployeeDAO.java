...
//    UPDATE an employee
//    *************************************
    public static void updateEmpEmail (String EMPLOYEE_ID, String FIRST_NAME,String LAST_NAME,String EMAIL) throws SQLException, ClassNotFoundException {
...
//                        "END;";
    ...
    public static void insertEmp (String name, String lastname, String email) throws SQLException, ClassNotFoundException {
        ...
        String updateStmt =
                ...
                "INSERT INTO employees(FIRST_NAME, LAST_NAME, EMAIL) VALUES('" + name + "','" + lastname + "','" + email+ "')";
//                "BEGIN\n" +
